...
export const runtimeContract = {
  ...
  resources: {
    local: {
      workerName: "aspt-nine-centers-reading",
      d1DatabaseName: "aspt-nine-centers-reading-site",
      r2BucketName: "aspt-nine-centers-reading-media",
      kvNamespaceName: "LOCAL_ASPT_NINE_CENTERS_READING_SESSION_KV",
    },
    preview: {
      workerName: "aspt-nine-centers-reading-preview",
      d1DatabaseName: "aspt-nine-centers-reading-preview-site",
      r2BucketName: "aspt-nine-centers-reading-preview-media",
      kvNamespaceName: "aspt-nine-centers-reading-preview-session",
    },
    production: {
      workerName: "aspt-nine-centers-reading-production",
      d1DatabaseName: "aspt-nine-centers-reading-production-site",
      r2BucketName: "aspt-nine-centers-reading-production-media",
      kvNamespaceName: "aspt-nine-centers-reading-production-session",
    },
  },
